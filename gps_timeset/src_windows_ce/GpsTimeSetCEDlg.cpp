...
void CGpsTimeSetCEDlg::PcTimeDisp(int nYear, int nMonth, int nDay, int nHour, int nMinutes, int nSecond, LPVOID pParam)
{
	...
	sTemp.Format(_T("%+02.1f"), (double)tzInfo.Bias / 60.0);

========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : DummyProg
========================================================================


AppWizard が生成した DummyProg には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには DummyProg を構成している各ファイルの概要説明が含まれています。
...
DummyProg.h
    ...
    みます） をインクルードし、また CDummyProgApp アプリケーションクラスを宣
    言します。

DummyProg.cpp
    このファイルは CDummyProgApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\DummyProg.ico
    ...
    ルです。このアイコンはリソース ファイル DummyProg.rc によってインクルード
    されます。
...
DummyProgDlg.h, DummyProgDlg.cpp - ダイアログ
    これらのファイルは CDummyProgDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な DummyProg.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) DummyProg.pch 
